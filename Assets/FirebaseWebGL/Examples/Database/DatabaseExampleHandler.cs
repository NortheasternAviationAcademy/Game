...
namespace FirebaseWebGL.Examples.Database
{
    public class DatabaseExampleHandler : MonoBehaviour
    {
        ...
        {
            FirebaseDatabase.PostJSON(pathInputField.text, valueInputField.text, gameObject.name,
                "DisplayInfo", "DisplayErrorObject");
        }

        public void PushJSON()
        {
            FirebaseDatabase.PushJSON(pathInputField.text, valueInputField.text, gameObject.name,
                "DisplayInfo", "DisplayErrorObject");
        }

        public void UpdateJSON()
        {
            FirebaseDatabase.UpdateJSON(pathInputField.text, valueInputField.text,
        ...
        {
            FirebaseDatabase.ListenForValueChanged(pathInputField.text, gameObject.name, "DisplayData",
                "DisplayErrorObject");
        }

        public void StopListeningForValueChanged()
        {
            FirebaseDatabase.StopListeningForValueChanged(pathInputField.text, gameObject.name, "DisplayInfo",
                "DisplayErrorObject");
        }

        public void ListenForChildAdded()
        {
            FirebaseDatabase.ListenForChildAdded(pathInputField.text, gameObject.name, "DisplayData",
                "DisplayErrorObject");
        }

        public void StopListeningForChildAdded()
        {
            FirebaseDatabase.StopListeningForChildAdded(pathInputField.text, gameObject.name, "DisplayInfo",
                "DisplayErrorObject");
        }

        public void ListenForChildChanged()
        {
            FirebaseDatabase.ListenForChildChanged(pathInputField.text, gameObject.name, "DisplayData",
                "DisplayErrorObject");
        }

        public void StopListeningForChildChanged()
        {
            FirebaseDatabase.StopListeningForChildChanged(pathInputField.text, gameObject.name, "DisplayInfo",
                "DisplayErrorObject");
        }

        public void ListenForChildRemoved()
        {
            FirebaseDatabase.ListenForChildRemoved(pathInputField.text, gameObject.name, "DisplayData",
                "DisplayErrorObject");
        }

        public void StopListeningForChildRemoved()
        {
            FirebaseDatabase.StopListeningForChildRemoved(pathInputField.text, gameObject.name, "DisplayInfo",
                "DisplayErrorObject");
        }
