...
namespace FirebaseWebGL.Scripts.FirebaseBridge
{
    public static class FirebaseAuth
    {
        ...
        /// <param name="callback">
        ///     Name of the method to call when the operation was successful. Method must have signature: void
        ///     Method(string output)
        /// </param>
        /// <param name="fallback">
        ///     Name of the method to call when the operation was unsuccessful. Method must have signature:
        ///     void Method(string output). Will return a serialized FirebaseError object
        /// </param>
        ...
        /// <param name="onUserSignedIn">
        ///     Name of the method to call when the user signs in. Method must have signature: void
        ///     Method(string output). Will return a serialized FirebaseUser object
        /// </param>
        /// <param name="onUserSignedOut">
        ///     Name of the method to call when the operation was unsuccessful. Method must have
        ///     signature: void Method(string output)
        /// </param>
        [DllImport("__Internal")]
