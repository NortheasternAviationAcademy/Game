...
namespace FirebaseWebGL.Scripts.FirebaseBridge
{
    public static class FirebaseDatabase
    {
        ...
        /// <param name="onChildAdded">
        ///     Name of the method to call when the listener is triggered. Method must have signature: void
        ///     Method(string output)
        /// </param>
        /// <param name="fallback">
        ///     Name of the method to call when the operation was unsuccessful. Method must have signature:
